...
namespace SecureSandbox
{
    ...
    public partial class Form_ProcessRights : Form
    {
        ...
        FilterRule currentFilterRule = null;
        ...
        {
            string information = "The process name can be the process image path, e.g. 'c:\\myfolder\\mytest.exe', or with file path mask, e.g. 'c:\\windows\\*.exe'. or only process name, e.g. 'notepad.exe'.\r\n\r\n";

            MessageBoxHelper.PrepToCenterMessageBoxOnForm(this);
            MessageBox.Show(information, "Process Name", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }       
